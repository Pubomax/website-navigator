...
const getContent = (isPathFrench: boolean) => ({
  title: isPathFrench ? "Solutions pour le Secteur Manufacturier" : "Manufacturing Solutions",
  subtitle: isPathFrench 
    ? "Solutions de transformation numérique adaptées aux opérations de fabrication modernes, améliorant l'efficacité et la productivité grâce à l'intégration de technologies intelligentes."
  ...
  sections: {
    ...
    solutions: {
      title: isPathFrench ? "Nos Solutions pour l'Industrie" : "Our Manufacturing Solutions",
      items: isPathFrench ? [
        {
    ...
    metrics: {
      title: isPathFrench ? "Indicateurs de Succès" : "Success Metrics",
      items: isPathFrench ? [
      ...
      <div className="container">
        ...
        >
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <h2>{content.sections.metrics.title}</h2>
            <ul>
              {content.sections.metrics.items.map((metric) => (
